...
const Hero = () => {
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      <div
        className={`absolute inset-0 top-[120px] max-w-7xl mx-auto ${styles.paddingX} flex flex-col sm:flex-row items-start gap-5 sm:gap-10`}
      >
      ...
      <div className='absolute xs:bottom-0 bottom-10 w-full flex justify-center items-center mt-8'>
        <a href='#about'>
